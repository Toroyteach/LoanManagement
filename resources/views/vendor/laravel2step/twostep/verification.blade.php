                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-12 text-center">
                                    ...
                                    <p class="text-danger">
                                        <small>
                                            <p id="counter" class="text-danger">Count Down Timer</p>
                                        </small>
                                    </p>
                                </div>
                                <div class="col-xs-12 text-center">
...
@section('foot')
    ...
    <script>
        ...
        var x = setInterval(function() {
            ...
            if (distance < 0) {
                clearInterval(x);
                document.getElementById("counter").innerHTML = "EXPIRED Reload page to be sent another code";
                //diable the input and ask user to reload page
            }
