...
Route::middleware(['auth'])->group(function () {
    Route::get('users/Details', 'Admin\UsersController@completeDetails')->name('users.details');
    Route::get('users/Fill/Details', 'Admin\UsersController@getUserFillProfile')->name('users.fill.details');
    Route::post('users/profile/update/firsttimelogin', 'Admin\UsersController@firstTimeLoginUpdate')->name('users.profile.firsttime');
});

Auth::routes(['register' => false]);
// Admin
Route::middleware(['auth' ,'twostep', 'fill_details'])->group(function () {
